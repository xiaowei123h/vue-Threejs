<template>
    <div class="webglBuffergeometryUint-container">
...
export default {
    ...
    methods: {
        init() {
            ...
            var normalAttribute = new this.$THREE.Int16BufferAttribute(normals, 3)
            var colorAttribute = new this.$THREE.Uint8BufferAttribute(colors, 3)
...
<style scoped>
.webglBuffergeometryUint-container {
    width: 100%;
}
</style>
