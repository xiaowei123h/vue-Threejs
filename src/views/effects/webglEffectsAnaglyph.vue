<template>
    <div class="webglEffectsAnaglyph-container">
        <div id="info">
...
<script>
import { AnaglyphEffect } from '@/components/jsm/effects/AnaglyphEffect.js'
export default {
    data() {
        return {
            container: null,
    ...
    methods: {
        init() {
            ...
            document.getElementsByClassName('webglEffectsAnaglyph-container')[0].appendChild(this.container)
        ...
        onDocumentMouseMove(event) {
            ...
            this.mouseX = (event.clientX - x - this.windowHalfX) / 100
...
<style scoped>
.webglEffectsAnaglyph-container {
    position: relative;
    width: 100%;
}
</style>