<template>
    <div class="webglGeometryTerrainFog-container">
...
export default {
    ...
    methods: {
        init() {
            ...
            this.scene.background = new this.$THREE.Color(0xefd1b5)
            this.scene.fog = new this.$THREE.FogExp2(0xefd1b5, 0.0025)
        ...
        generateHeight(width, height) {
            ...
            var perlin = new ImprovedNoise(), z = Math.random() * 100
            var quality = 1
            for (var j = 0; j < 4; j ++) {
