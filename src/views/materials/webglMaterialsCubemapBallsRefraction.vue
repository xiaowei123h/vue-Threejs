<template>
    <div class="webglMaterialsCubemapBallsRefraction-container">
        <div id="info">
...
export default {
    ...
    methods: {
        init() {
            ...
            document.getElementsByClassName('webglMaterialsCubemapBallsRefraction-container')[0].appendChild(this.container)
            ...
            var material = new this.$THREE.MeshBasicMaterial({ color: 0xffffff, envMap: this.scene.background, refractionRatio: 0.95 })
            material.envMap.mapping = this.$THREE.CubeRefractionMapping
            for (var i = 0; i < 500; i ++) {
