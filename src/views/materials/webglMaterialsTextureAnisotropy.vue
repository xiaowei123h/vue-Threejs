...
export default {
    ...
    methods: {
        init() {
            ...
            document.getElementsByClassName('webglMaterialsTextureAnisotropy-container')[0].appendChild(this.container)
            ...
            var texture1 = textureLoader.load("static/textures/crate.gif")
            ...
            var texture2 = textureLoader.load("static/textures/crate.gif")
