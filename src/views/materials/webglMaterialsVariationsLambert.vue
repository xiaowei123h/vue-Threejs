<template>
    <div class="webglMaterialsVariationsLambert-container">
...
export default {
    ...
    methods: {
        init(font) {
            ...
            document.getElementsByClassName('webglMaterialsVariationsLambert-container')[0].appendChild(this.container)
            ...
            addLabel("+hue", new this.$THREE.Vector3(- 350, 0, 0))
            addLabel("-hue", new this.$THREE.Vector3(350, 0, 0))
            addLabel("-reflectivity", new this.$THREE.Vector3(0, - 300, 0))
            addLabel("+reflectivity", new this.$THREE.Vector3(0, 300, 0))
            addLabel("-diffuse", new this.$THREE.Vector3(0, 0, - 300))
            addLabel("+diffuse", new this.$THREE.Vector3(0, 0, 300))
            addLabel("envMap", new this.$THREE.Vector3(- 350, 300, 0))
            addLabel("no envMap", new this.$THREE.Vector3(350, 300, 0))
...
<style scoped>
.webglMaterialsVariationsLambert-container {
    position: relative;
    width: 100%;
}
</style>
