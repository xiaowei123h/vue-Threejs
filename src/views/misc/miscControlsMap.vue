<template>
    <div class="miscControlsMap-container">
        <div id="info">
...
import { MapControls } from '@/components/jsm/controls/OrbitControls.js'
export default {
    data() {
        return {
            camera: null,
    ...
    methods: {
        init() {
            ...
            document.getElementsByClassName('miscControlsMap-container')[0].appendChild(this.renderer.domElement)
