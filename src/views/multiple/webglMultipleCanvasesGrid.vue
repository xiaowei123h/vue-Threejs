...
<script>
import { View } from '@/utils/webglMultipleCanvasesGrid.js'
export default {
    data() {
        return {
            views: [],
    ...
    methods: {
        init() {
            ...
            this.views.push(new View(canvas1, fullWidth, fullHeight, w * 0, h * 0, w, h, this.$THREE, this.scene, this.renderer))
            this.views.push(new View(canvas2, fullWidth, fullHeight, w * 1, h * 0, w, h, this.$THREE, this.scene, this.renderer))
            this.views.push(new View(canvas3, fullWidth, fullHeight, w * 0, h * 1, w, h, this.$THREE, this.scene, this.renderer))
            this.views.push(new View(canvas4, fullWidth, fullHeight, w * 1, h * 1, w, h, this.$THREE, this.scene, this.renderer))
            //
